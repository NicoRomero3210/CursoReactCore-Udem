...
//Aca como parametro resiviria props, pero aplicando destrucuturacion se le puede asignar asi los valores de
//props a la vble image directamente y asi usar eso en vez de la vble props
const Image = ({ image }) => (
  <div className='card'>
    <img
      src={image.source}
